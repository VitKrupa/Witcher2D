...
W.Backgrounds.swamp = function(ctx, cameraX) {
    ...
    for (let i = -1; i < 8; i++) {
        ...
        // Dead tree trunk
        ctx.fillRect(tx + 60, gnd - 160, 6, 140);
        // Bare branches
        ctx.save();
        ctx.translate(tx + 63, gnd - 140);
        ctx.rotate(-0.5);
        ctx.fillRect(0, 0, 35, 3);
        ctx.restore();
        ctx.save();
        ctx.translate(tx + 63, gnd - 120);
        ctx.rotate(0.4);
        ctx.fillRect(0, 0, 30, 3);
        ctx.restore();
        ctx.save();
        ctx.translate(tx + 63, gnd - 100);
        ctx.rotate(-0.3);
    ...
    ctx.fillRect(ruinX, gnd - 120, 40, 80);
    ctx.fillRect(ruinX + 30, gnd - 100, 25, 60);
    ctx.beginPath();
    ctx.moveTo(ruinX - 5, gnd - 120); ctx.lineTo(ruinX + 20, gnd - 150); ctx.lineTo(ruinX + 45, gnd - 120);
    ctx.fill();
    ...
    for (let i = -1; i < 8; i++) {
        ...
        ctx.fillRect(tx + 65, gnd - 140, 10, 130);
        // Visible roots
        ctx.fillRect(tx + 55, gnd - 20, 30, 5);
        ctx.fillRect(tx + 50, gnd - 22, 8, 8);
        ctx.fillRect(tx + 85, gnd - 22, 8, 8);
        // Branches with hanging moss
        ctx.save();
        ctx.translate(tx + 70, gnd - 120);
        ctx.rotate(-0.45);
    ...
    for (let i = 0; i < 6; i++) {
        ...
        ctx.fillRect(mx, gnd - 5, 2, 6);
        ctx.fillStyle = '#8a4a2a';
        ctx.beginPath();
        ctx.arc(mx + 1, gnd - 6, 4, Math.PI, 0);
        ctx.fill();
        ctx.fillRect(mx + 6, gnd - 3, 2, 4);
        ctx.fillStyle = '#6a3a1a';
        ctx.beginPath();
        ctx.arc(mx + 7, gnd - 4, 3, Math.PI, 0);
        ctx.fill();
    }
    ...
    for (let i = 0; i < 8; i++) {
        ...
        ctx.beginPath();
        ctx.arc(fx, gnd - 80 + (i % 3) * 20, 3, 0, Math.PI * 2);
        ctx.fill();
        // Glow
        ctx.fillStyle = `rgba(60,255,100,${pulse * 0.15})`;
        ctx.beginPath();
        ctx.arc(fx, gnd - 80 + (i % 3) * 20, 10, 0, Math.PI * 2);
        ctx.fill();
    }
    ...
    for (let i = 0; i < 15; i++) {
        ...
        ctx.fillRect(rx + sway * 0.5, gnd - 20, 2, 30);
        ctx.fillStyle = '#3a2a1a';
        ctx.fillRect(rx - 1 + sway, gnd - 22, 4, 6);
    }
    ...
    for (let i = -1; i < 6; i++) {
        ...
        ctx.beginPath();
        ctx.ellipse(fogX + 125, gnd + 10, 140, 20, 0, 0, Math.PI * 2);
        ctx.fill();
    }
    ...
    for (let i = 0; i < 8; i++) {
        ...
        const fy = gnd - 70 + Math.sin(t * 0.5 + i * 1.7) * 40;
    ...
    for (let i = 0; i < 3; i++) {
        ...
        ctx.fillRect(bx, gnd + 8, 12, 2);
        ctx.fillRect(bx + 4, gnd + 6, 2, 6);
    }
};
})();
